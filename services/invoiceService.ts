...
export const generateTicketReport = (tickets: TicketEntry[], reportTitle: string, isAdminView: boolean) => {
  ...
  const tableColumnAdmin = ["Staff", "Issue Date", "Passenger", "PNR", "Status", "Route", "Airline", "Departure", "Arrival", "Issuer"];
  const tableColumnStaff = ["Issue Date", "Passenger", "PNR", "Status", "Route", "Airline", "Departure", "Arrival", "Issuer"];
  ...
  const staffColumnStyles = {
    ...
    1: { cellWidth: 35 },    // Passenger
    2: { cellWidth: 25 },    // PNR
    3: { cellWidth: 20 },    // Status
    4: { cellWidth: 35 },    // Route
    5: { cellWidth: 25 },    // Airline
  ...
  const adminColumnStyles = {
    0: { cellWidth: 25 },    // Staff
    1: { cellWidth: 20 },    // Issue Date
    2: { cellWidth: 35 },    // Passenger
    3: { cellWidth: 25 },    // PNR
    4: { cellWidth: 20 },    // Status
    5: { cellWidth: 35 },    // Route
    6: { cellWidth: 25 },    // Airline
    7: { cellWidth: 25 },    // Departure
    8: { cellWidth: 25 },    // Arrival
    9: { cellWidth: 25 },    // Issuer
  };
